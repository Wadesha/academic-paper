...
\usepackage{hyperref}
\title{Efficient Climate Model Downscaling Deep Learning: A Resource-Aware Approach}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Climate Model Downscaling Deep Learning and analyse its cost/quality trade-off.
