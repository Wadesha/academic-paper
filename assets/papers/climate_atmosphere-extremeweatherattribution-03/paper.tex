...
\usepackage{hyperref}
\title{Scalable Extreme Weather Attribution for Large-Scale Settings}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We decompose the problem across shards with a communication-efficient aggregation rule that keeps overhead sublinear in scale. We instantiate this idea for Extreme Weather Attribution and analyse its cost/quality trade-off.
