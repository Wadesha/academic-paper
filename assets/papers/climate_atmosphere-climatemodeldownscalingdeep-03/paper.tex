...
\usepackage{hyperref}
\title{Scalable Climate Model Downscaling Deep Learning for Large-Scale Settings}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We decompose the problem across shards with a communication-efficient aggregation rule that keeps overhead sublinear in scale. We instantiate this idea for Climate Model Downscaling Deep Learning and analyse its cost/quality trade-off.
