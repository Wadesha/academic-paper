...
\usepackage{hyperref}
\title{Robust Ocean Heat Content Trend under Distribution Shift}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We model distribution shift explicitly and optimise a worst-case objective over an uncertainty set of plausible test distributions. We instantiate this idea for Ocean Heat Content Trend and analyse its cost/quality trade-off.
