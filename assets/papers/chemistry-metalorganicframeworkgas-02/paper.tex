...
\usepackage{hyperref}
\title{Robust Metal Organic Framework Gas Storage under Distribution Shift}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We model distribution shift explicitly and optimise a worst-case objective over an uncertainty set of plausible test distributions. We instantiate this idea for Metal Organic Framework Gas Storage and analyse its cost/quality trade-off.
