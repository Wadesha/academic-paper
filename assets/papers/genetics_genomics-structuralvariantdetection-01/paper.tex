...
\usepackage{hyperref}
\title{Efficient Structural Variant Detection: A Resource-Aware Approach}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Structural Variant Detection and analyse its cost/quality trade-off.
