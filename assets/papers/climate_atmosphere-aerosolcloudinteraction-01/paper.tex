...
\usepackage{hyperref}
\title{Efficient Aerosol Cloud Interaction: A Resource-Aware Approach}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Aerosol Cloud Interaction and analyse its cost/quality trade-off.
