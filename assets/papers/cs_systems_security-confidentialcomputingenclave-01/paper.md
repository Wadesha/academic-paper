# Efficient Confidential Computing Enclave: A Resource-Aware Approach
...
## 3. Method
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Confidential Computing Enclave.
