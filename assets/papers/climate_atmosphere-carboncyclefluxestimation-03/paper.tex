...
\usepackage{hyperref}
\title{Scalable Carbon Cycle Flux Estimation for Large-Scale Settings}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We decompose the problem across shards with a communication-efficient aggregation rule that keeps overhead sublinear in scale. We instantiate this idea for Carbon Cycle Flux Estimation and analyse its cost/quality trade-off.
