...
\usepackage{hyperref}
\title{Efficient Crispr Gene Editing Off Target: A Resource-Aware Approach}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Crispr Gene Editing Off Target and analyse its cost/quality trade-off.
