...
\usepackage{hyperref}
\title{Efficient Developmental Biology Morphogenesis: A Resource-Aware Approach}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We reduce the dominant computational cost via adaptive resource allocation, activating only the components needed per input. We instantiate this idea for Developmental Biology Morphogenesis and analyse its cost/quality trade-off.
