...
\usepackage{hyperref}
\title{Scalable Kernel Scheduling Data Center for Large-Scale Settings}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We decompose the problem across shards with a communication-efficient aggregation rule that keeps overhead sublinear in scale. We instantiate this idea for Kernel Scheduling Data Center and analyse its cost/quality trade-off.
