...
\usepackage{hyperref}
\title{Scalable Landslide Susceptibility Mapping for Large-Scale Settings}
\author{Anonymous}
\date{}
\begin{document}
\maketitle
...
\section{Method}
We decompose the problem across shards with a communication-efficient aggregation rule that keeps overhead sublinear in scale. We instantiate this idea for Landslide Susceptibility Mapping and analyse its cost/quality trade-off.
